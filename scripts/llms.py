...
def write_llms(menu, bar, notation, kin):
    ...
    lines = [
        ...
        "/drink/ indexes them, /menu/<section>/ is one section of the printed",
        "card and /shape/<pattern>/ is one shape, each listing what it holds.",
        "",
        "## Start here",
        "",
        f"- [The app]({ORIGIN}/): interactive menu, Bar tab, and the Barline key",
        f"- [Every drink]({ORIGIN}/drink/): one page per drink, A to Z, and a page per section and shape",
